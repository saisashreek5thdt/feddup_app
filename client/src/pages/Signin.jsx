    ...
    return (
        <div>
            ...
            <div className={['w-3/12 mx-auto pt-44']} style={{zIndex : '1000'}}>
                ...
                <form className={["mt-8"]}>
                    ...
                    <div className={['flex justify-center mt-4']}>
                        <button className={['py-2 px-8 mx-4 text-sm font-light text-white border rounded-full']}>ADMIN</button>
                        <button className={['py-2 px-8 mx-4 text-sm font-light text-white border rounded-full']}>SKIP</button>
                    </div>
                </form>
            </div>
            ...
            <div className={['flex justify-center transform scale-150']}>
                <img src={Logo} alt="" className={['transform scale-150 mt-32']} />
            </div>
        </div>
    )
}
