        ...
        <div className={['relative overflow-hidden']}>
            ...
            <div className={['w-3/12 mx-auto pt-32']} style={{zIndex : '1000'}}>
                ...
                <form className={[""]}>
                    ...
                    <div className={['flex border py-4 px-5 rounded rounded-full mb-10']}>
                        <img src={passwordicon} alt="" className={['mr-5 transform scale-75']} />
                        <input type="text" name="" id="" placeholder="Re-Password" />
                    </div>
            ...
            <img src={Registerbg} alt="" className={['absolute scale-125 transform']} style={{top : '520px', zIndex: '-1'}} />
            ...
            <div className={["flex justify-center pt-16 pb-12"]}>
                ...
                <img src={linkedin} alt="" className={['transform scale-90']} />
                <img src={twitter} alt="" className={['transform scale-90']} />
            </div>
        </div>
    )
}
